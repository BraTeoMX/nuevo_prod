...
class ActualizacionController extends Controller
{
    ...
    public function index()
    {
        ...
        $hora = date("G").":00"; 
        $activePage = '';
        $teamModul = team_modulo::where('team_leader','<>','0')->orderby('team_leader', 'asc')->orderby('modulo', 'asc')->get();
    ...
    public function actualizarDatos(Request $request)
    {
        ...
        foreach ($formData as $data) {
            ...
            if ($teamModulInfo) {
                ...
                $existingRecord = Plan_diar::where('id_planeacion', $id . '-' . $teamModulInfo->team_leader)

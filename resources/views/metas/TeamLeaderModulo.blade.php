            ...
            <div class="card-body">
              ...
              <form action="{{ route('agregarTeamLeader') }}" method="post" class="form-inline">
                ...
                <div class="form-group mb-2">
                    <label for="nombre" class="sr-only">Nombre del Team Leader:</label>
                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre del Team Leader" required>
                </div>
                ...
                <button type="submit" class="btn btn-primary mb-2">Agregar Team Leader</button>
            </form>
            {{--Fin del formulario  --}}
            {{-- Campo de búsqueda --}}
            <div>
                <input type="text" id="searchInput" class="form-control mb-4" onkeyup="filterTable()" placeholder="Buscar por team leader o módulo...">
            </div>
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
            <div class="card-body">
              ...
              <form action="{{ route('agregarTeamLeader') }}" method="post" class="form-inline">
                    ...
                    <div class="form-group mb-2">
                        <label for="nombre" class="sr-only">Nombre del Team Leader:</label>
                        <input type="text" class="form-control" id="nombre2" name="nombre" placeholder="Nombre del Team Leader" required>
                    </div>
                    <div class="form-group mx-sm-3 mb-2">
                        <label for="modulo" class="sr-only">Módulo:</label>
            ...
            {{-- Campo de búsqueda --}}
            <div>
                <input type="text" id="searchInput2" class="form-control mb-4" onkeyup="filterTable2()" placeholder="Buscar por Team Leader o módulo...">
            </div>
